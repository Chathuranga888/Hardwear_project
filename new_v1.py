...
def face_image_capture_window():
    ...
    [sg.Text('Please click the button below and place your face properly in the frame that follows and we will take a photo within five seconds.\nMake sure your face is clearly visible and well lit.\n',justification='center', size=(200, 3),font=('Helvetica', 12),key='instruction_text')],
...
def main():
    ...
    while True:
        ...
        if event == sg.WIN_CLOSED:
                ...
                if event == sg.WIN_CLOSED:
                    ...
                    while True:
                        ...
                        if event == sg.WIN_CLOSED:
                            ...
                            camera.stop_preview()
                            face_image_capture['image'].update(filename=thumbs_up_img)
                            face_image_capture['instruction_text'].update('Photo captured successfully!')
            ...
            charge_window.close()
            # auto_close_popup()
            sg.popup_auto_close('We charge your phone safly!', auto_close_duration=1, keep_on_top=True, button_type=sg.POPUP_BUTTONS_NO_BUTTONS,image=thumbs_up_img)
    create_main_window.close()
